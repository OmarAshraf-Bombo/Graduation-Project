...
namespace FinalWebSite.Controllers
{
    public class RequestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Request_ID,Msl7a_ID,Mostanad_ID,No_of_copies,Citizen_ID,Printed_or_not,toPrint,Phone_Number,Msg_Sent_Or_Not")] Request request)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Request_ID,Msl7a_ID,Mostanad_ID,No_of_copies,Citizen_ID,Printed_or_not,toPrint,Phone_Number,Msg_Sent_Or_Not")] Request request)
        {
            if (ModelState.IsValid)
            {
