...
namespace RasberryPiFinalProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        public static string rq, tm, mn, mm, noc, nam, re;
        ...
        public ActionResult Create()
        {
            ...
            foreach (Citizen element in db.Citizens)
            {
                if ((element.National_ID == nam) && (element.Password == pass))
                {
                    ...
                    return RedirectToAction("Details/" + element.National_ID, "Citizens");
        ...
        { 
            foreach (Request x in db.Requests)
            { 
                if ((rq == x.Citizen_ID && x.toPrint == null) || (rq==x.Citizen_ID && x.toPrint == false))
                {
                    x.toPrint = true;
                }
                else { }
            ...
            return Redirect("http://localhost:57104/Citizens/Details/"+rq);
        }
    }
}
